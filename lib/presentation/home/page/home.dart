...
import 'package:taskati/presentation/home/cubit/app_cubit.dart';
                ...
                Positioned(
                  ...
                  child: BlocListener<AppCubit, AppState>(
                    listener: (context, state) {
                      if (state is AppUpdit) {
                        navigator(context, AddTask());
                        context.read<AppCubit>().restart();
                      }
                    },
                    child: Builder(
                      builder: (context) {
                        return ElevatedButton(
                          ...
                          child: Text(
                            "+",
                            style: TextStyles.titel.copyWith(
